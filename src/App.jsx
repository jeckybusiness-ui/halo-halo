...
const SCENARIOS = [
  ...
  { id: 1, title: "Hapus Chat Mantan", genre: "Micro-Cheating", pov: "Suami", story: "Tengah malam, HP-mu bergetar. Notifikasi dari mantan: 'Aku kangen kita'. Panik, kamu langsung menghapus chat itu tanpa membalas. Besoknya istrimu mengecek folder 'Sampah' dan menemukannya.", question: "Apa pembelaanmu?", options: [{ id: 'A', text: "Demi perasaanmu.", consequence: "Niat baik tapi salah." }, { id: 'B', text: "Aku salah.", consequence: "Jujur." }, { id: 'C', text: "Gak ada apa-apa.", consequence: "Mencurigakan." }] },
  ...
  { id: 8, title: "Pasangan Gendut", genre: "Fisik", pov: "Suami", story: "Istri naik 30kg, tanya 'Aku seksi gak?'. Jujur, gairahmu mati.", question: "Jawabanmu?", options: [{ id: 'A', text: "Bohong: Seksi.", consequence: "Masalah lanjut." }, { id: 'B', text: "Jujur: Kurang.", consequence: "Menyakitkan." }, { id: 'C', text: "Diet bareng.", consequence: "Menyinggung." }] },
  ...
  { id: 18, title: "Anak Bully", genre: "Parenting", pov: "Istri", story: "Anak memukul teman. Suami malah membela 'Anakku jagoan'.", question: "Sikapmu?", options: [{ id: 'A', text: "Lawan suami.", consequence: "Anak bingung." }, { id: 'B', text: "Diam.", consequence: "Anak jadi bully." }, { id: 'C', text: "Sekolah hukum.", consequence: "Lepas tangan." }] },
...
// ... (Other components StickerOverlay, StickerPanel remain same)
...
const MultiplayerGameScreen = ({ 
    ...
    if (gameData?.scenarioOrder && gameData.scenarioOrder.length > 0) {
        ...
        // Use find because IDs start at 1, but array index starts at 0
        currentScenario = SCENARIOS.find(s => s.id === actualScenarioIndex + 1) || SCENARIOS[actualScenarioIndex % SCENARIOS.length];
    } else {
